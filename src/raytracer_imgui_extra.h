...
inline bool DragDoubleN(const char* label, 
	void* p_data, int components, float v_speed = 0.1, 
	const double p_min = 0.0, const double p_max = 0.0, const char* format = "%.2f", 
